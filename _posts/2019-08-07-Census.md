...
<tbody>
  ...
  <tr>
   ...
   <td style="text-align:right;width: 2in; "> <span style="     color: red !important;">0.04</span> </td>
...
Les dues variables que més relació tenen amb Income son marital.status i relationship.  
...
Això implica que el percentatge de 'husband' és molt més elevat que el de 'wife'.  
...
# aplica receptes a les dades de training
preparada <- 
  recepte %>% 
  prep() 
...
<table class="table table-striped table-hover table-condensed" style="margin-left: auto; margin-right: auto;">
<caption>Mètriques del Model</caption>
 <thead>
  <tr>
