...
Personalitzar una série d'eines i automatismes per a la exploració analitica de les dades.  
Test del paquet Tidymodels per una classificacio d'una série d'observacions mitjançant un model de regressio logistica. 
